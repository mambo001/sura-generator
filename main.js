...
const generateSuraButton = document.querySelector("#generateSura");
...
generateSuraButton.addEventListener("click", handleGenerateSura);

function handleGenerateSura(evt) {
